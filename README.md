# Local DevOps Sandbox for Monitoring & Alerting (All-in-One VM)
...
### Step:-2 Run the installation script by giving it execution permission
```bash
chmod +x script.sh
sudo ./script.sh
```
